...
const ContactUs = () => {
    ...
    return (
        <Container className='mt-5'>
            <h2 className="fs-1 fw-bold my-5 text-1 text-uppercase">Contact Us</h2>
                ...
                <div className="col-md-7">
                    <form className='col-md-7 mx-auto w-100' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Link to='/' className='text-decoration-none'>
                            <Button className='px-5 button border-0 bg-1'><i className="fas fa-shopping-cart me-3"></i>Send Your Query</Button>
                        </Link>
                    </form>
