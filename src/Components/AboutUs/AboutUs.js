        ...
        <Container className='mt-5'>
            ...
            <div className="row g-5">
                ...
                <div className="col-md-7 text-start">
                    ...
                    <h2 className="text-1"> CONVENIENCE</h2>
                    <p className="text-secondary">
                        ...
                        What’s more, with easy access to reliable drug 1rmation, you get to know all about your medicine at M.Pharma, and once you’re a Netmeds customer, you’ll get regular refill reminders, so you’ll never again come up short of medicines.
                    </p>


                    <h2 className="text-1"> ONE-STOP SHOP</h2>
                    <p className="text-secondary">
