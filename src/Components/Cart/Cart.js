                        ...
                        <div className="col-md-6">
                            <form className='col-md-7 mx-auto' onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <FloatingLabel controlId="floatingInput" label="Flat/Floor" className="mb-3 text-1">
                                    <Form.Control className='border-1 text-1' type="text" placeholder="Flat/Floor "  {...register("flatFloor", { required: true })} />
                                </FloatingLabel>
                                <FloatingLabel controlId="floatingInput" label="Road Name/No" className="mb-3 text-1">
                                    <Form.Control className='border-1 text-1' type="text" placeholder="Road Name/No"  {...register("roadNameNo", { required: true })} />
                                </FloatingLabel>
                                <FloatingLabel controlId="floatingInput" label="Additional Instruction" className="mb-3 text-1">
                                    <Form.Control className='border-1 text-1' type="text" placeholder="Additional Instruction"  {...register("additionalInstruction", { required: true })} />
                                </FloatingLabel>
